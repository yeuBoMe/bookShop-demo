...
image::image-2025-12-09-10-17-17-595.png[Login]

=== B2: Lấy access token từ response của server
image::image-2025-12-09-10-19-04-374.png[Access Token]

=== B3: Phân tích JWT → xác định thuật toán HS256
image::image-2025-12-09-10-19-38-450.png[Phân tích JWT]

=== B4: Tạo wordlist các secret key yếu 32-byte trong thư mục hashcat
image::image-2025-12-09-10-20-06-463.png[Tạo wordlist]
...
image::image-2025-12-09-10-22-44-388.png[Hashcat cracked]

=== B6: Forge token mới với role = ADMIN bằng Python
Script `forge.py` đã có sẵn trong thư mục hashcat
image::image-2025-12-09-10-23-53-465.png[Script forge.py]
...
image::image-2025-12-09-10-24-43-668.png[Fake ADMIN token]

=== B7: So sánh trước và sau khi tấn công

*Trước khi crack (role = USER)*
image::image-2025-12-09-10-25-51-415.png[Trước khi crack]

*Sau khi dùng token giả mạo (role = ADMIN)*
image::image-2025-12-09-10-26-01-772.png[Sau khi crack]
